...
# ── Header Banner ──
st.markdown(f"""
<div style="display:flex; align-items:center; gap:24px; padding:28px 32px; background:linear-gradient(135deg, #00B1A9 0%, #00897B 100%); border-radius:16px; margin-bottom:12px; box-shadow:0 8px 32px rgba(0,141,134,0.2); border:1px solid rgba(255,255,255,0.12);">
<img src="{_logo_banner_uri}" style="height:64px; flex-shrink:0; filter:brightness(1.05);" />
<div style="min-width:0;">
<h1 style="color:#FFFFFF; margin:0; font-weight:800; font-size:1.5rem; text-transform:uppercase; letter-spacing:0.5px; line-height:1.15;">MyCareerX Report Hub</h1>
<p style="color:rgba(255,255,255,0.85); margin:4px 0 0 0; font-size:0.92rem; font-weight:400;">Centralized reporting toolkit for BAU Support weekly updates and monthly management presentations.</p>
</div>
</div>
""", unsafe_allow_html=True)
