...
st.markdown(f"""
<div style="display: flex; align-items: center; gap: 16px; padding: 24px 32px; background-color: #00B1A9; border-radius: 20px; margin-bottom: 2.5rem; box-shadow: 0 12px 30px rgba(0, 177, 169, 0.25); overflow: hidden; border: 1px solid rgba(255, 255, 255, 0.1);">
    ...
    <div style="min-width: 0;">
        <h1 style="margin: 0 !important; color: #FFFFFF !important; font-weight: 800 !important; text-transform: uppercase; font-size: 0.8rem !important; letter-spacing: 0.3px; white-space: nowrap;">Weekly SR &amp; Incident Report Generator</h1>
        <p style="margin: 4px 0 0 0 !important; color: #FFFFFF !important; font-size: 0.7rem !important; opacity: 0.85; font-weight: 400; white-space: nowrap;">Automate your MyGenie Excel exports into production-ready HTML email reports.</p>
    </div>
</div>
""", unsafe_allow_html=True)
